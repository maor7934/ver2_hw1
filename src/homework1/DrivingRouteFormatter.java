...
public class DrivingRouteFormatter extends RouteFormatter {
	 ...
	 *         traverse this geographical feature.<br>
	 ...
	 * </tt>
	 *         <p>
	 *         In the output above, "Hanita" represents the name of the geographic
	 *         feature, and "1.4 kilometers" is the length of the geographic
	 *         feature. The length should be reported to tenth-of-a-kilometer
	 *         precision. The String should be terminated by a newline and should
	 *         include no extra spaces other than those shown above.
	 **/
	public String computeLine(GeoFeature geoFeature, double origHeading) {
		...
		String direction_line = this.getTurnString(origHeading, geoFeature.getStartHeading())
				+ " onto " + geoFeature.getName() + " and go " + geoFeature.getLength() + "kilometers.";
